...
C
C     XNPH: time step of heat flux update [# hours]
      XNPX=1.0*XNPH
      DO 9995 NX=NHW,NHE
      DO 9990 NY=NVN,NVS
C
...
C
C     TQROC: DOC in runoff
C     only the first three complexes are subjected to runoff
C     
      DO 9880 K=0,2
      TQROC(K,NY,NX)=0.0
      TQRON(K,NY,NX)=0.0
...
C     MACROPORES
C
C     DFHOC: diffusion flux of DOC for each substrate complex
C     Diffusivities for dissolved C, N, P and acetate are same
      DO 9785 K=0,4
